...
#ifdef Q_WS_MAC
    #include "ui_mac_tutorialswindow.h"
#else
    #ifdef Q_OS_LINUX
        #include "ui_nix_tutorialswindow.h"
    #else
        #ifdef Q_OS_WIN32
            #include "ui_win_tutorialswindow.h"
        #endif
    #endif
#endif

tutorialsWindow::tutorialsWindow(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::tutorialsWindow) {
    ui->setupUi(this);
